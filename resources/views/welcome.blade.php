<x-layouts.app>
    ...
    <!-- Navigation Grid -->
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-6 auto-rows-fr">
        <x-page-link
            href="/about"
            title="About"
        ...
        <x-page-link
            href="/area-service"
            title="Area Service"
            description="Area service committee information"
        ...
        <x-page-link
            href="/speakers"
            title="Speakers"
            description="Recovery speaker recordings"
        ...
        <x-page-link
            href="/cleantime-calculator"
            title="Cleantime Calculator"
            description="Calculate your clean time"
        ...
        <x-page-link
            ...
            description="Information for professionals"
        ...
        <x-page-link
            href="/literature"
            title="Literature"
            description="Recovery literature and readings"
            icon='<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />'
        />
    </div>
    </div>
